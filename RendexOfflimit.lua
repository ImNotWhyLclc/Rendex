...
-- Create main window with custom icon
local MainWindow = WindUI:CreateWindow({
    Title = "Rendex Off Limits",  -- Changed to requested name
    Icon = "rbxassetid://80907668293140",  -- YOUR CUSTOM ICON
    Author = "Rendex",
...
-- FIXED: Moved these functions to the top to prevent "attempt to call nil value" errors
...
CombatSection:Input({
    Title = "Hitbox Size",
    Desc = "Set hitbox size multiplier (default: 2)",
    Default = "2",
    Callback = function(value)
...
WindUI:Notify({
    ...
    Content = "All features working correctly! Fixed line 118 and tools icon.",
    Duration = 5,
    Icon = "shield-check"
})
